"""
CeleryWorkflow 1 - Backend API
Python Celery workflow engine with task chains, retries, and result tracking
"""
...
app = FastAPI(
    title="CeleryWorkflow 1",
    description="Python Celery workflow engine with task chains, retries, and result tracking",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "CeleryWorkflow 1"}
